...
extern inline void rdpq_load_tlut(uint8_t tile, uint8_t lowidx, uint8_t highidx);
extern inline void rdpq_set_tile_size_fx(uint8_t tile, uint16_t s0, uint16_t t0, uint16_t s1, uint16_t t1);
extern inline void rdpq_load_block(uint8_t tile, uint16_t s0, uint16_t t0, uint16_t num_texels, uint16_t tmem_pitch);
extern inline void rdpq_load_block_fx(uint8_t tile, uint16_t s0, uint16_t t0, uint16_t num_texels, uint16_t dxt);
extern inline void rdpq_load_tile_fx(uint8_t tile, uint16_t s0, uint16_t t0, uint16_t s1, uint16_t t1);
extern inline void rdpq_set_tile_full(uint8_t tile, tex_format_t format, uint16_t tmem_addr, uint16_t tmem_pitch, uint8_t palette, uint8_t ct, uint8_t mt, uint8_t mask_t, uint8_t shift_t, uint8_t cs, uint8_t ms, uint8_t mask_s, uint8_t shift_s);
...
extern inline void rdpq_set_tile(uint8_t tile, tex_format_t format, uint16_t tmem_addr, uint16_t tmem_pitch, uint8_t palette);
