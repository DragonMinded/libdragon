...
#define DL_DRAM_LOWPRI_BUFFER_SIZE   0x1000
#define DL_DRAM_HIGHPRI_BUFFER_SIZE  0x80
...
#define DL_LOWPRI_CALL_SLOT        (DL_MAX_BLOCK_NESTING_LEVEL+0)
#define DL_HIGHPRI_CALL_SLOT       (DL_MAX_BLOCK_NESTING_LEVEL+1)
