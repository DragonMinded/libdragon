...
/* Code */
        ...
        (pByteStream[2]&0xFE) == 0x00)
    {
        ...
        while (1)
        {
            ...
            if (byteCount == len)
            {
                strmBuffSize = byteCount - initByteCount - zeroCount;
                break;
            }
    ...
    #ifdef H264BSD_N64
    pStrmData->pStart    = pByteStream + initByteCount;
    pStrmData->pCurr     = (u64)(u32)pStrmData->pStart << 3;
    pStrmData->pEnd      = pStrmData->pCurr + strmBuffSize*8;
    #else
    ...
    pStrmData->strmBuffSize      = strmBuffSize;
    #endif

    /* return number of bytes "consumed" */
    *readBytes = strmBuffSize + initByteCount + zeroCount;
    ...
    if (hasEmulation)
    {
        tmp = strmBuffSize;
        #ifdef H264BSD_N64
        readPtr = writePtr = pStrmData->pStart;
        #else
        ...
        #ifdef H264BSD_N64
        pStrmData->pEnd -= (u32)(readPtr - writePtr)*8;
        #else
