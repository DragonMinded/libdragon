...
/* Code */
    ...
    #else
    ASSERT(STRM_CURR_BITOFF(pStrmData) < 8);
    stuffingLength = 8 - STRM_CURR_BITOFF(pStrmData);
    #endif
...
/* Code */
    ...
    #else
    ASSERT(pStrmData->pCurr <= pStrmData->pEnd);
    bits = pStrmData->pEnd - pStrmData->pCurr;
    #endif
