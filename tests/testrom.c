...
static const struct Testsuite
{
	...
	TEST_FUNC(test_rdpq_fog_color,             0, TEST_FLAGS_NO_BENCHMARK),
	TEST_FUNC(test_rdpq_blend_color,           0, TEST_FLAGS_NO_BENCHMARK),
	...
	TEST_FUNC(test_rdpq_mat_blend_rgb,         0, TEST_FLAGS_NO_BENCHMARK),
	TEST_FUNC(test_rdpq_mat_blend_rgb_with_alphacompare, 0, TEST_FLAGS_NO_BENCHMARK),
	TEST_FUNC(test_rdpq_mat_fog_rgb, 		   0, TEST_FLAGS_NO_BENCHMARK),
	TEST_FUNC(test_rdpq_mat_fog_alpha, 		   0, TEST_FLAGS_NO_BENCHMARK),
	TEST_FUNC(test_rdpq_mat_fog_rgb_and_alpha, 0, TEST_FLAGS_NO_BENCHMARK),
	TEST_FUNC(test_rdpq_mat_fog_rgb_and_const, 0, TEST_FLAGS_NO_BENCHMARK),
	TEST_FUNC(test_rdpq_mat_blender_const,     0, TEST_FLAGS_NO_BENCHMARK),
