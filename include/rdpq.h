 ...
 * RDP command set, including triangles. Even for RDP commands generated by CPU,
 ...
 * as keeping the log active for a whole frame can produce too much information.
 * 
 */
 ...
 * an address into one of the available slots.
 * 
