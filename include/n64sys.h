...
/**
 * @brief Get 32-bit of random entropy
 *
 * This function returns a true 32-bit random number, that changes at every
 * boot. This number is generated by collecting entropy during the early boot
 * process from various hardware sources. It can be used to seed a pseudo
 * random number generator. For instance:
 *
 * \code{c}
 *      // Seed rand() with the boot entropy
 *      srand(sys_get_entropy());
 * \endcode
 *
 * @note On most emulators, this function will always return the same value.
 */
