 ...
 * functionally equivalent to a call to #rsqp_write, but it allows to
 ...
 * #rspq_write_begin + #rspq_write_arg + #rspq_write_end should be exactly
 * the same as a single call to #rspq_write.
 * 
