...
#define RSPQ_RDP_STATIC_BUFFER_SIZE    0x200
...
#define ASSERT_INVALID_OVERLAY       0x0001    ///< A command is referencing an overlay that is not registered
#define ASSERT_INVALID_COMMAND       0x0002    ///< The requested command is not defined in the overlay
